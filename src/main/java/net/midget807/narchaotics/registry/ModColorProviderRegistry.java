...
public class ModColorProviderRegistry {
    ...
    public static void registerItemColors() {
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0x812626 - FUCKASS_COLOR_CONSTANT,
                ModItems.NETHERRACK_SOLUTION_BUCKET, ModItems.NETHERRACK_SOLUTION_CONICAL_FLASK, ModItems.NETHERRACK_SOLUTION_ROUND_FLASK, ModItems.NETHERRACK_SOLUTION_BEAKER, ModItems.NETHERRACK_SOLUTION_TEST_TUBE, ModItems.NETHERRACK_DUST);
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0xff8700 - FUCKASS_COLOR_CONSTANT,
                ModItems.SULPHURIC_ACID_BUCKET, ModItems.SULPHURIC_ACID_CONICAL_FLASK, ModItems.SULPHURIC_ACID_ROUND_FLASK, ModItems.SULPHURIC_ACID_BEAKER, ModItems.SULPHURIC_ACID_TEST_TUBE, ModItems.SULPHURIC_ACID);
