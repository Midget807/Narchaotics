...
public class ModColorProviderRegistry {
    ...
    public static void registerItemColors() {
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0x4b93f4 - FUCKASS_COLOR_CONSTANT,
                ModItems.VOLCANIC_WATER_BUCKET, ModItems.VOLCANIC_WATER_CONICAL_FLASK, ModItems.VOLCANIC_WATER_ROUND_FLASK, ModItems.VOLCANIC_WATER_BEAKER, ModItems.VOLCANIC_WATER_TEST_TUBE);
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0xec1e1e - FUCKASS_COLOR_CONSTANT,
                ModItems.RED_PHOSPHORUS_BUCKET, ModItems.RED_PHOSPHORUS_CONICAL_FLASK, ModItems.RED_PHOSPHORUS_ROUND_FLASK, ModItems.RED_PHOSPHORUS_BEAKER, ModItems.RED_PHOSPHORUS_TEST_TUBE);
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0x647062 - FUCKASS_COLOR_CONSTANT,
                ModItems.CLEAN_ASH_SOLUTION_BUCKET, ModItems.CLEAN_ASH_SOLUTION_CONICAL_FLASK, ModItems.CLEAN_ASH_SOLUTION_ROUND_FLASK, ModItems.CLEAN_ASH_SOLUTION_BEAKER, ModItems.CLEAN_ASH_SOLUTION_TEST_TUBE);
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0x8644e3 - FUCKASS_COLOR_CONSTANT,
                ModItems.IODINE_BUCKET, ModItems.IODINE_CONICAL_FLASK, ModItems.IODINE_ROUND_FLASK, ModItems.IODINE_BEAKER, ModItems.IODINE_TEST_TUBE);

        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0xffe1ba - FUCKASS_COLOR_CONSTANT,
                ModItems.SALT_SOLUTION_BUCKET, ModItems.SALT_SOLUTION_CONICAL_FLASK, ModItems.SALT_SOLUTION_ROUND_FLASK, ModItems.SALT_SOLUTION_BEAKER, ModItems.SALT_SOLUTION_TEST_TUBE);
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0xe89627 - FUCKASS_COLOR_CONSTANT,
                ModItems.SODIUM_CARBONATE_BUCKET, ModItems.SODIUM_CARBONATE_CONICAL_FLASK, ModItems.SODIUM_CARBONATE_ROUND_FLASK, ModItems.SODIUM_CARBONATE_BEAKER, ModItems.SODIUM_CARBONATE_TEST_TUBE);
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) -> tintIndex > 0 ? -1 : 0xe7be5d - FUCKASS_COLOR_CONSTANT,
                ModItems.ALKALINE_EPHEDRA_SOLUTION_BUCKET, ModItems.ALKALINE_EPHEDRA_SOLUTION_CONICAL_FLASK, ModItems.ALKALINE_EPHEDRA_SOLUTION_ROUND_FLASK, ModItems.ALKALINE_EPHEDRA_SOLUTION_BEAKER, ModItems.ALKALINE_EPHEDRA_SOLUTION_TEST_TUBE);
