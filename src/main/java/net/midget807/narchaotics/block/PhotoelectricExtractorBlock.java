...
public class PhotoelectricExtractorBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<FilterWorkbenchBlock> CODEC = createCodec(FilterWorkbenchBlock::new);
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, ModBlockEntities.PHOTOELECTRIC_EXTRACTOR, (world1, pos, state1, blockEntity) -> blockEntity.tick(world1, pos, state1));
    }
}
