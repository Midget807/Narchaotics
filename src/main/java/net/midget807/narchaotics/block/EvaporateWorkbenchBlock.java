...
public class EvaporateWorkbenchBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<EvaporateWorkbenchBlock> CODEC = createCodec(EvaporateWorkbenchBlock::new);
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    public EvaporateWorkbenchBlock(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new EvaporateWorkbenchBlockEntity(pos, state);
    }
