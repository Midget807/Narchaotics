...
public class DissolveWorkbenchBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final MapCodec<DissolveWorkbenchBlock> CODEC = createCodec(DissolveWorkbenchBlock::new);
    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    public DissolveWorkbenchBlock(Settings settings) {
        super(settings);
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DissolveWorkbenchBlockEntity(pos, state);
    }
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        ...
        return validateTicker(type, ModBlockEntities.DISSOLVE_WORKBENCH, (world1, pos, state1, blockEntity) -> blockEntity.tick(world1, pos, state1));
    }
}
