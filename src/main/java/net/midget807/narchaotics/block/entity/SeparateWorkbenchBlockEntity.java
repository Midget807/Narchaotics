            ...
            switch (slot) {
                ...
                case 2: {
                    ...
                    if (stack.getItem() instanceof BucketItem) {
                        ...
                        if (this.insertStack(FLUID_OUTPUT_INDICES[2], remainderStack, productFluidStorage2, fluid, stack)) {
                            stack.decrement(1);
                            this.setStack(slot, stack);
                        ...
                        if (remainderStack != null && this.insertStack(FLUID_OUTPUT_INDICES[2], remainderStack, productFluidStorage2, fluid, stack)) {
                            stack.decrement(1);
                            this.setStack(slot, stack);
