...
public class EvaporateWorkbenchBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    private final PropertyDelegate propertyDelegate = new PropertyDelegate() {
        ...
        public int get(int index) {
            return (int) switch (index) {
                ...
                case 4 -> EvaporateWorkbenchBlockEntity.this.reactantFluidStorage2.amount;
                case 5 -> EvaporateWorkbenchBlockEntity.this.productFluidStorage1.amount;
                case 6 -> EvaporateWorkbenchBlockEntity.this.productFluidStorage2.amount;
                default -> 0;
            };
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                ...
                case 4: EvaporateWorkbenchBlockEntity.this.reactantFluidStorage2.amount = value;
                case 5: EvaporateWorkbenchBlockEntity.this.productFluidStorage1.amount = value;
                case 6: EvaporateWorkbenchBlockEntity.this.productFluidStorage2.amount = value;
            }
        }
