...
public class FilterWorkbenchBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory, RecipeUnlocker, RecipeInputProvider {
    ...
    private final PropertyDelegate propertyDelegate = new PropertyDelegate() {
        ...
        public int get(int index) {
            return (int) switch (index) {
                ...
                case 4 -> FilterWorkbenchBlockEntity.this.productFluidStorage1.amount;
                default -> 0;
            };
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                ...
                case 4: FilterWorkbenchBlockEntity.this.productFluidStorage1.amount = value;
            }
        }
            ...
            switch (slot) {
                ...
                case 1: {
                    ...
                    if (stack.getItem() instanceof BucketItem) {
                        ...
                        if (this.insertStack(FLUID_OUTPUT_INDICES[1], remainderStack, productFluidStorage1, fluid, stack)) {
                            stack.decrement(1);
                            this.setStack(slot, stack);
                        ...
                        if (remainderStack != null && this.insertStack(FLUID_OUTPUT_INDICES[1], remainderStack, productFluidStorage1, fluid, stack)) {
                            stack.decrement(1);
                            this.setStack(slot, stack);
    ...
    private static int getCookTime(World world, FilterWorkbenchBlockEntity blockEntity) {
