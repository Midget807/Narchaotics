...
public class DissolveWorkbenchBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    private final PropertyDelegate propertyDelegate = new PropertyDelegate() {
        ...
        public int get(int index) {
            return (int) switch (index) {
                ...
                case 6 -> DissolveWorkbenchBlockEntity.this.productFluidStorage2.amount;
                default -> 0;
            };
        }
        ...
        public void set(int index, int value) {
            switch (index) {
                ...
                case 6: DissolveWorkbenchBlockEntity.this.productFluidStorage2.amount = value;
            }
        }
