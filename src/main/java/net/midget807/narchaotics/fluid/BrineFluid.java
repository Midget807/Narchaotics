...
public abstract class BrineFluid extends AbstractModFluid {
    @Override
    public Fluid getStill() {
        return ModFluids.BRINE;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.BRINE_FLOWING;
    }
    ...
    public Item narchaotics$getConicalFlaskItem() {
        return ModItems.BRINE_CONICAL_FLASK;
    }

    @Override
    public Item narchaotics$getRoundFlaskItem() {
        return ModItems.BRINE_ROUND_FLASK;
    }

    @Override
    public Item narchaotics$getBeakerItem() {
        return ModItems.BRINE_BEAKER;
    }

    @Override
    public Item narchaotics$getTestTubeItem() {
        return ModItems.BRINE_TEST_TUBE;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModBlocks.BRINE.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
