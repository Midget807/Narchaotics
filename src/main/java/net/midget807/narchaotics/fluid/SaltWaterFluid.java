...
public abstract class SaltWaterFluid extends AbstractModFluid{
    @Override
    public Fluid getStill() {
        return ModFluids.SALT_WATER;
    }

    @Override
    public Fluid getFlowing() {
        return ModFluids.SALT_WATER_FLOWING;
    }
    ...
    public Item narchaotics$getConicalFlaskItem() {
        return ModItems.SALT_WATER_CONICAL_FLASK;
    }

    @Override
    public Item narchaotics$getRoundFlaskItem() {
        return ModItems.SALT_WATER_ROUND_FLASK;
    }

    @Override
    public Item narchaotics$getBeakerItem() {
        return ModItems.SALT_WATER_BEAKER;
    }

    @Override
    public Item narchaotics$getTestTubeItem() {
        return ModItems.SALT_WATER_TEST_TUBE;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModBlocks.SALT_WATER.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
