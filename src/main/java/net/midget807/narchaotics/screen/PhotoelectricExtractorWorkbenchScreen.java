...
public class PhotoelectricExtractorWorkbenchScreen extends HandledScreen<PhotoelectricExtractorScreenHandler> {
    ...
    public PhotoelectricExtractorWorkbenchScreen(PhotoelectricExtractorScreenHandler handler, PlayerInventory inventory, Text title) {
