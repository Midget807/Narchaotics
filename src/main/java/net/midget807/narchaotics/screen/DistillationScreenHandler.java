...
import static net.midget807.narchaotics.block.entity.DistillationWorkbenchBlockEntity.*;
import static net.midget807.narchaotics.util.ModScreenUtil.*;

public class DistillationScreenHandler extends ScreenHandler {
    public Inventory inventory;
    public final PropertyDelegate propertyDelegate;
    public final DistillationWorkbenchBlockEntity blockEntity;

    public DistillationScreenHandler(int syncId, PlayerInventory playerInventory, BlockPos pos) {
        this(syncId, playerInventory, playerInventory.player.getEntityWorld().getBlockEntity(pos), new ArrayPropertyDelegate(7));
    }

    public DistillationScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate propertyDelegate) {
        super(ModScreenHandlers.DISTILLING_WORKBENCH, syncId);
        checkDataCount(propertyDelegate, 7);
        this.inventory = (Inventory) blockEntity;
        this.blockEntity = (DistillationWorkbenchBlockEntity) blockEntity;
        ...
        this.addSlot(new FluidInputSlot(inventory, FLUID_INPUT_INDICES[2], 183, 23));
        this.addSlot(new FluidInputSlot(inventory, FLUID_INPUT_INDICES[3], 183, 81));

        this.addSlot(new Slot(inventory, FUEL_INPUT_INDEX, 98, 100));

        this.addSlot(new OutputSlot(inventory, OUTPUT_INDICES[0], 129, 49));
        this.addSlot(new OutputSlot(inventory, OUTPUT_INDICES[1], 129, 79));
        ...
        this.addSlot(new FluidOutputSlot(inventory, FLUID_OUTPUT_INDICES[2], 183, 45));
        this.addSlot(new FluidOutputSlot(inventory, FLUID_OUTPUT_INDICES[3], 183, 103));
