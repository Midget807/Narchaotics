...
public class FilterWorkbenchScreen extends HandledScreen<FilterScreenHandler> {
    ...
    public FilterWorkbenchScreen(FilterScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        drawFluid(context, handler.blockEntity.reactantFluidStorage1.variant, 57, 61, 22, ModScreenUtil.getHeightForVolume(handler.blockEntity.reactantFluidStorage1, 22), 22);
