...
public class DisposalTankScreen extends HandledScreen<DisposalTankScreenHandler> {
    ...
    public static final Identifier DISPOSAL_TEXTURE = NarchaoticsMain.id("textures/gui/container/disposal_menu.png");
    ...
    public DisposalTankScreen(DisposalTankScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(DISPOSAL_TEXTURE, x, y, 0, BACKGROUND_X_OFFSET, 0, BACKGROUND_WIDTH, BACKGROUND_HEIGHT, 256, 256);
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        drawFluid(context, handler.blockEntity.reactantFluidStorage1.variant, 36, 49, 46, ModScreenUtil.getHeightForVolume(handler.blockEntity.reactantFluidStorage1, 46), 46);
