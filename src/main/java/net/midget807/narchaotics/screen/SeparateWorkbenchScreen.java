...
public class SeparateWorkbenchScreen extends HandledScreen<SeparateScreenHandler> {
    ...
    public SeparateWorkbenchScreen(SeparateScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(SEPARATE_TEXTURE, x, y, 0, BACKGROUND_X_OFFSET, 0, BACKGROUND_WIDTH, BACKGROUND_HEIGHT, 256, 256);
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        drawFluid(context, handler.blockEntity.reactantFluidStorage1.variant, 57, 41, 22, ModScreenUtil.getHeightForVolume(handler.blockEntity.reactantFluidStorage1, 22), 22);
        drawFluid(context, handler.blockEntity.productFluidStorage1.variant, 133, 41, 22, ModScreenUtil.getHeightForVolume(handler.blockEntity.productFluidStorage1, 22), 22);
        drawFluid(context, handler.blockEntity.productFluidStorage2.variant, 96, 86, 22, ModScreenUtil.getHeightForVolume(handler.blockEntity.productFluidStorage2, 22), 22);
