...
public class EvaporateWorkbenchScreen extends HandledScreen<EvaporateScreenHandler> {
    ...
    public EvaporateWorkbenchScreen(EvaporateScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(EVAPORATE_TEXTURE, x, y, 0, BACKGROUND_X_OFFSET, 0, BACKGROUND_WIDTH, BACKGROUND_HEIGHT, 256, 256);
